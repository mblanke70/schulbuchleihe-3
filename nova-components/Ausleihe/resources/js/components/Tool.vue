...
export default {
    ...
    methods: {
        ...
        getJahrgaenge() {
            Nova.request().post('/nova-vendor/ausleihe')
                .then(response => {
        ...
        getKlassen() {
            Nova.request().get('/nova-vendor/ausleihe/' 
        ...
        buchAusleihen() {                       
            Nova.request().post('/nova-vendor/ausleihe/'
                ...
                .then(response => {
                    ...
                    this.$toasted.show(this.__('Buch wurde ausgeliehen!'), {
                        type: 'success',
                    });
                ...
                .catch(error => {
                    ...
                    this.$toasted.show(this.__('Fehler: ' + this.errors.buchId[0]), {
                        type: 'error',
                    });
                });
